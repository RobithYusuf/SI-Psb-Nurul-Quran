...
<head>
    ...
    <style type="text/css" media="all">
        * {
        ...
        .header-item span, .footer-item span {
            font-weight: bold;
            font-size: 20px;
        }
        ...
        .header-item.italic, .footer-item.italic {
            font-style: italic;
            font-size: 7px;
        }
        .report-title {
        ...
        .report-period, .data-count {
            font-size: 10px;
            color: #333;
            padding: 0;
            margin: 0;
        }
        .report-period span, .data-count span {
            font-weight: bold;
        }
        .center-text {
            text-align: center;
...
<body>
    ...
    <div class="report-title">Laporan Pendaftaran Santri</div>
